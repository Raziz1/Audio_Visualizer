/* autogenerated by Processing revision 1283 on 2022-05-06 */
...
public class Music_Visualizer_MINIM extends PApplet {
...
//==========Variables==========
float[] spectrum;
float decay = 0.9f, heightScale;
float beatCircle_decay=0.925f, beatCircle_scale;
...
//==========Setup Function==========
 public void setup()
{
  /* size commented out by preprocessor */; //Use 3D graphics renderer
 ...
 */
 public void setGradient(int x, int y, float w, float h, float bands) {
  for (int i = y; i >= y+h; i--) { //Start a counter from the top y coordinate (bottom of the band) and count until it has reached the bottom y coodinate (top of the band)
    ...
    int gradientBandColor; //Define the gradient colors
 ...
 */
 ...
 public void setRadialGradient(int x, int y, float circleRadius) {
  float radius = circleRadius;
  int circleGradientColor;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Music_Visualizer_MINIM" };
    if (passedArgs != null) {
